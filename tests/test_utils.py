...
class TestWordsOfLength(unittest.TestCase):
    ...
    def test_length_zero(self):
        self.assertEqual(words_of_length(0, 'ab', lazy = False), ('',))
    ...
    def test_length_twelve(self):
        self.assertEqual(len(words_of_length(12, 'ab', lazy = False)), 2 ** 12)
    ...
    def test_empty_alphabet(self):
        self.assertEqual(words_of_length(1, '', lazy = False), tuple())


class TestWordsToLength(unittest.TestCase):

    def test_length_zero(self):
        self.assertEqual(words_to_length(0, 'ab', lazy = False), ('',))
    ...
    def test_empty_alphabet(self):
        self.assertEqual(words_to_length(1, '', lazy = False), ('',))
